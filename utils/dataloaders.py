...
class LoadImages_single:
    """YOLOv5 image/video dataloader, i.e. `python detect.py --source image.jpg/vid.mp4`."""

    def __init__(self, path, figtype,img_size=640, stride=32, auto=True, transforms=None, vid_stride=1):
        """Initializes YOLOv5 loader for images/videos, supporting glob patterns, directories, and lists of paths."""
    ...
    def __next__(self):
        ...
        if self.type==1:
            ...
            im0 = cv2.cvtColor(img_array, cv2.COLOR_RGB2BGR)
        else:
        ...
        return self.path, im, im0, self.cap, s
