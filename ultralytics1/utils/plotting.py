...
class Annotator:
    ...
    def box_label(self, box, label="", c=0,color=(128, 128, 128), txt_color=(255, 255, 255), rotated=False):
        """
    ...
    def box_label_png(self, box, label="", c=0,color=(128, 128, 128), txt_color=(255, 255, 255), rotated=False):
        """
        Draws a bounding box to image with label.
